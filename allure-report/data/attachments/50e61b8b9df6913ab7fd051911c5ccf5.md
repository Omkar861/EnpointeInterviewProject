...
- Name: bookingflowsss.spec.js >> Positive Test Cases >> Quick Book button should be enabled after selecting all fields
- Location: tests\bookingflowsss.spec.js:53:3

# Error details

```
Error: page.goto: net::ERR_SSL_PROTOCOL_ERROR at https://www.cinepolisindia.com/
Call log:
