...
- Name: bookingflowsss.spec.js >> Negative Test Cases >> User cannot proceed when seat API fails
- Location: tests\bookingflowsss.spec.js:120:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://www.cinepolisindia.com/
Call log:
